...
public extension UIStoryboard {
    ...
    internal class func splashViewController() -> MVSplashViewController {
        let vc = mainStoryboard().instantiateViewController(withIdentifier: "SplashViewController") as! MVSplashViewController
        return vc
    }
